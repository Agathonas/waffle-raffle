#[starknet::contract]
mod Raffle {
    use starknet::{get_block_timestamp, get_caller_address, contract_address_const, ContractAddress};
    ...
    trait IRaffle {
        ...
        fn enter_raffle(raffle_id: u256, entries: u256);
        fn end_raffle(raffle_id: u256);
    }

    // External functions
    #[external(v0)]
    impl RaffleImpl of IRaffle {
        fn create_raffle(
